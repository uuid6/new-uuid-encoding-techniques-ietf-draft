...
| Base32   | Hex        | `V0EKVBJTTG8T19R502GCI7JBUO`                            | `0123456789ABCDEFGHIJKLMNOPQRSTUV`                                 | 26                                                | Y                   | N                       | N                                         | N                                             | N                                 | Y                                                     | Y                     | Y                                   | Y                         | N                                             | Y                                                    | Y                                                       | N                                             | [RFC4648][RFC4648]                                            |                                                                                                                                                     |
...
| Base32   | geohash    | `z0fnzcmxxh8x19v502hdk7mcys`                            | `0123456789bcdefghjkmnpqrstuvwxyz`                                 | 26                                                | N                   | N                       | N                                         | Y                                             | N                                 | Y                                                     | Y                     | Y                                   | Y                         | Y                                             | Y                                                    | Y                                                       | N                                             | [py-geohash][py-geohash]                                      | Trailing 0's removed?                                                                                                                               |
